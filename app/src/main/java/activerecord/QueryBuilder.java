...
public class QueryBuilder {
    ...
    public static List<List<String>> getBuilder() {
        ...
        String TABLE_SPORT = "CREATE TABLE t_sport (t_id INTEGER PRIMARY KEY AUTOINCREMENT, t_category text, dt_created date, t_hours int)";
        String TABLE_PERSON = "CREATE TABLE t_person (t_id INTEGER PRIMARY KEY AUTOINCREMENT, t_address text, "
                + "dt_birthday date, dt_created date, t_email text, t_gender bool, t_password text, t_sport int, t_username text)";
